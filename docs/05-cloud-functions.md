# 05 — Cloud Function: Watcher

Sempre Cloud Storage per spec JSON e diff changes. Nessuna logica condizionale.

---

## `functions/src/watcher.fn.ts`
...
async function processConfig(
  ...
  // Deduplication: se l'hash esiste già, nulla è cambiato
  ...
  // Genera diff con la versione precedente
...
// ─── Genera diff e salva su Storage + metadati in Firestore ──────────────────
